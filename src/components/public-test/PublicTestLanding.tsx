  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Error message */}
        {error && (
          <div className="flex items-start gap-2 rounded-lg bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 p-3 text-sm text-red-700 dark:text-red-400">
