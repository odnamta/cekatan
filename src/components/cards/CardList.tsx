...
import { cardListReducer, initialCardListState } from './cardListReducer'
import type { CardListAction } from './cardListReducer'
...
// State management types and reducer extracted to ./cardListReducer.ts (#174)
